 ...
 * 表格时间格式化
 */
export function formatDate(cellValue: number | string | Date): string {
...
export function formatTime(time: any, option?: string): string {
  ...
  const d: number = new Date(time).getTime()
 ...
 * @returns {Object}
 */
export function objectMerge(target: object, source: object | Array<any>): object {
